    ...
    return (
       <section className='container mx-auto'>
        <div className='px-24 py-6'>
            <div className='w-full h-screen text-center flex flex-col justify-center items-center space-y-6 rounded-2xl' style={style}>
                <h1 className='text-[52px] w-10/12 font-bold text-white '>Discover an exceptional cooking class tailored for you!</h1>
                <p className='w-10/12 text-lg text-white mb-6'>Learn and Master Basic Programming, Data Structures, Algorithm, OOP, Database and solve 500+ coding problems to become an exceptionally well world-class Programmer.</p>
